...
void UActionBarViewModel::OnInitializeViewModel(APlayerController* PlayerController)
{
	...
	{
		OnAbilityToggleStateChanged(HeroPC->IsAbilityTogglePressed());
		HeroPC->OnAbilityToggleStateChangedDelegate.AddUObject(this, &UActionBarViewModel::OnAbilityToggleStateChanged);
